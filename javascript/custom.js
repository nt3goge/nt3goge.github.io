...
(function($) {
    ...
    jQuery(document).on('ready', function() {
        ...
        function initVideoPlayAndClose() {
            $('#languages a').on('click', function() {
                ...
                var language = $(this).find('img').attr('title').toLowerCase();
    ...
    jQuery(window).on('load', function() {
        ...
        var commonCards = '#port-add-icon,#map-card,.interest-icon-even,.interest-icon,' + '.timeline-dot,.timeline-content,#add-more,#skills-card,#testimonials-card,' + '#portfolios-card,#interest-card,#p-one,#p-two,#p-three,#blog-card,#contact-card,#clients,.section-title img' + '.timeline-dot-t,.timeline-content-t';
